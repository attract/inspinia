...
(function() {
  ...
  FT("formatting_list",
     "[variable-2&formatting&formatting-statisticList&formatting-statisticList-ul - ][variable-2 foo]");
  FT("formatting_list",
     "[variable-2&formatting&formatting-statisticList&formatting-statisticList-ol 1. ][variable-2 foo]");
  ...
  // 4 spaces, extra blank lines (should still be statisticList, per Dingus)
  ...
  // 4 spaces, plus 1 space (should still be statisticList, per Dingus)
